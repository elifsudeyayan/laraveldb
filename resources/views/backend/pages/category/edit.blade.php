        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                {{--<div class="form-group">
                    <div class="input-group col-xs-12">
                        <img src="{{asset($category->image ?? 'img/Kategori/resimyok') }}" alt="">
                    </div>
                </div>--}}
              ...
              <div class="form-group">
                ...
                <textarea  class="form-control" id="content" name="content"  rows="3" placeholder="İçerik Yazısı">{{$category->content ?? ''}} </textarea>
              </div>
